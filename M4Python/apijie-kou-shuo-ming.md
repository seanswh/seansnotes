...
2. 站点数据类
   ...
   3. string GetObsSerialFromMDFS\(string stationID, string table_name, string elementList, string startTime, string endTime, int interval\)：获取观测时序。stationID:站点ID。_table\_name：表名称，可参考
