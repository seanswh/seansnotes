...
那么，相应的齐次坐标是什么形式呢？我们可以使用简洁的形式非常简单地得到齐次坐标。我可以把旋转矩阵记作R，记住，这是一个3×3的矩阵。至于平移矩阵，我们刚刚学习过，这里是单位矩阵，并且是一个3阶单位矩阵，单位矩阵乘以旋转矩阵依然是旋转矩阵本身，加上平移向量乘以0，结果仍然是旋转矩阵。![](/Computer_Graphics/images/12.png)