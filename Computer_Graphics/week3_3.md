...
法向和平面中任何向量的点积为0。所以，如果你考虑平面上的点P，P可以是三角形中任何一点，这里是P，然后你考虑向量P减A，它在平面上，法向与它的点积为0，即：n·(P - A)= 0，即P·n - A·n= 0。光线是P0 + P1 * t。我们把它代入平面方程，即： (P0 + P1 * t)·n = A·n，求t即可得到交点，你得到的t是：((A·n) - (P0·n)) / (P1·n)。