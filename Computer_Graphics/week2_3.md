...
光源分成以下几种：
  ...
  Phong的想法是，他想找到一个简单的方法来处理基于观察位置上的高光，类似于漫射光，选择视线和反射光线之间的点积，除此之外，给cosine项增加指数来控制表面到底有多光泽，高光到底有多亮。还有一种替代方法，取光源、视线之间的角度的一半，然后求它和法向的点积。这样它更加接近标准的漫反射光照，漫反射光照中是光线和法向的点积，这个是半角和法向的点积，并且再一次地，你可以增加它的指数。这就是Blinn-Phong模型，实际上，对于物理表面来说，
半角的形式更为准确。它是标准OpenGL中的形式，
也是我要求你们实现的。
