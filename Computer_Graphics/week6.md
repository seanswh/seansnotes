...
透视变换gluPerspective。当你进行gluPerspective变换的时候，记住你应该对gluLookAt的结果应用gluPerspective，最终的变换矩阵是投影矩阵乘以一个叫做模型视图矩阵的矩阵，或gluPerspective * gluLookAt然后就得到了屏幕坐标，它也被叫做规格化设备坐标。它从-1到+1，是一个立方体。
